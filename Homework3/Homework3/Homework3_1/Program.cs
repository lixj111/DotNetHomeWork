    ...
    class ShapeFactory
    {
        public static Shape generateRandomShape(int seed)
        {
            ...
            switch(key)
            {
                ...
                case 1: shape = new Rectangle(rd.NextDouble() + rd.Next(0,10), rd.NextDouble() + rd.Next(0,10));
                    Console.WriteLine("矩形");break;
                case 2: shape = new Triangle(rd.NextDouble() + rd.Next(2, 5), rd.NextDouble() + rd.Next(2, 5), rd.NextDouble() + rd.Next(2, 5));
